    ...
    return (
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
        <div className="relative flex-1">
          ...
          <Input
            type="email"
            placeholder={isLoaded ? t("newsletter.placeholder") : "Email của bạn"}
            value={email}
        ...
        >
          {isSubmitting ? (isLoaded ? t("newsletter.subscribing") : "Đang đăng ký...") : isLoaded ? t("newsletter.subscribe").toUpperCase() : "ĐĂNG KÝ"}
        </Button>
